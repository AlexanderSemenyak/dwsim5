...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Class Compressor
        ...
        Public Overrides Function LoadData(data As ICollection(Of System.Xml.Linq.XElement)) As Boolean
...
Curves:             Me.PropertyPackage.CurrentMaterialStream = msin
                ...
                Case CalculationMode.Delta_P, CalculationMode.OutletPressure
                    ...
                    If DebugMode Then AppendDebugLine(String.Format(SolutionInspector.Calculated_Outlet_Temperature_0_K, T2))
