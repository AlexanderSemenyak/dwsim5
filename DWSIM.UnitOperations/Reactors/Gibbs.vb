    ...
    <System.Serializable()> Public Class Reactor_Gibbs
        ...
        Public Overrides Function LoadData(data As ICollection(Of XElement)) As Boolean
            ...
            For Each xel2 As XElement In (From xel As XElement In data Select xel Where xel.Name = "Elements").Elements
                elmns.Add(xel2.@ID)
            Next
            _elements = elmns.ToArray(GetType(System.String))
            ...
            Next
            _totalelements = telmns.ToArray(GetType(System.Double))
...
#Region "Auxiliary Functions"
        ...
        Private Function FunctionValue2G2(ByVal x() As Double, T As Double) As Double
            ...
            Dim fv = pp.DW_CalcFugCoeff(xv, T, P, PropertyPackages.State.Vapor)
