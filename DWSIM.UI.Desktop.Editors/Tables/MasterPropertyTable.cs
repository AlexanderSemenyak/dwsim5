...
namespace DWSIM.UI.Desktop.Editors.Tables
{
    public class MasterPropertyTableEditor : Form
    {
        ...
        void Init()
        {
            ...
            topcontainer.Rows.Add(new TableRow(new Label { Text = "Заголовок таблицы", VerticalAlignment = VerticalAlignment.Center }, header, new Label { Text = "Количество сгруппированных строк", VerticalAlignment = VerticalAlignment.Center }, nsNumberOfLines));
